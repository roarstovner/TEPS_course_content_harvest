...
```r
Rscript R/generate_data_notes.R  # Reads courses_with_plan_id.RDS + plan_lookup.RDS
```
...
└── generate_data_notes.R  # Regenerate data/data_notes.md from current data
...
├── data_notes.md          # Data quality documentation (generated by R/generate_data_notes.R)
└── checkpoint/
