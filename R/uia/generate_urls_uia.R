...
local({
  ...
  csv_ts <- file.path(outd, sprintf("candidates_%s_%s.csv", inst_short, ts))
  txt_ts <- file.path(outd, sprintf("candidates_%s_%s.txt", inst_short, ts))
  ...
  # latest-pekerne
  file.copy("data/output/uia/candidates_latest.csv", "data/output/uia/course_urls_latest.csv", overwrite = TRUE)
  file.copy("data/output/uia/candidates_latest.txt", "data/output/uia/course_urls_latest.txt", overwrite = TRUE)
