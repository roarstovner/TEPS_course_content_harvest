...
output <- tribble(
  ~url, ~html, ~fulltekst,
  "https://[...]", "<head> html-koden [...]", "M5GEN100 Engelsk, emne ...",
...
These are suggested steps. When the work proceeds, you will have more knowledge of this than me, so feel free to suggest changes.
...
There should be something in the rvest-package that does this automatically? I imagine a function that adds an `html` variable to the above tibble.
